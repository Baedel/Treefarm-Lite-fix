...
({
    ...
    -- Group
    {
        ...
        order = "e",
        inventory_order = "e",
        icon = "__Treefarm-Lite-fix__/graphics/icons/treefarm.png",
        icon_size = 32
    },
    ...
    -- Item: Mk1 field
    {
        type = "item",
        name = "tf-field",
        icon = "__Treefarm-Lite-fix__/graphics/icons/field.png",
        icon_size = 32,
    ...
    -- Entitiy: Mk1 field
    {
        ...
        animation =
        {
            filename = "__Treefarm-Lite-fix__/graphics/entities/field/field.png",
            priority = "extra-high",
            width = 512,
            height = 512,
            frame_count = 1,
        ...
        {
            filename = "__Treefarm-Lite-fix__/graphics/icons/empty.png",
            priority = "extra-high",
            width = 32,
            height = 32,
            frame_count = 1,
    ...
    -- Item: Mk2 field
    {
        type = "item",
        name = "tf-fieldmk2",
        icon = "__Treefarm-Lite-fix__/graphics/icons/fieldmk2.png",
        icon_size = 32,
        flags = {"goes-to-quickbar"},
        subgroup = "tf-buildings",
        order = "b[fieldmk2]",
    ...
    -- Entity: Mk2 field overlay
    {
        ...
        picture =
        {
            filename = "__Treefarm-Lite-fix__/graphics/entities/fieldmk2/fieldmk2Overlay.png",
            priority = "extra-high",
            width = 640,
            height = 640,
            shift = {0.0, 0.0}
    ...
    -- Entity: Mk2 field
    {
        ...
        picture =
        {
            filename = "__Treefarm-Lite-fix__/graphics/entities/fieldmk2/fieldmk2.png",
            priority = "extra-high",
            width = 128,
            height = 175,
            shift = {0.9375, -1.3125}
        ...
        animation =
        {
            north =
            {
                filename = "__Treefarm-Lite-fix__/graphics/entities/fieldmk2/field-2.png",
                width = 314,
                height = 270,
                frame_count = 1,
                shift = {0.9375, -1.3125}
    ...
    -- Decorative: green overlay
    {
        type = "decorative",
        name = "tf-overlay-green",
        flags = {"placeable-neutral", "not-on-map"},
        icon = "__Treefarm-Lite-fix__/graphics/entities/fieldmk2/tf-overlay-1.png",
        icon_size = 32,
        subgroup = "grass",
        ...
        {
            {
                filename = "__Treefarm-Lite-fix__/graphics/entities/fieldmk2/tf-overlay-1.png",
                width = 32,
                height = 32,
                shift = {-0.5, -0.5}
            }
    ...
    -- Decorative: gred overlay    
    {
        type = "decorative",
        name = "tf-overlay-red",
        flags = {"placeable-neutral", "not-on-map"},
        icon = "__Treefarm-Lite-fix__/graphics/entities/fieldmk2/tf-overlay-2.png",
        icon_size = 32,
        subgroup = "grass",
        ...
        {
            {
                filename = "__Treefarm-Lite-fix__/graphics/entities/fieldmk2/tf-overlay-2.png",
                width = 32,
                height = 32,
                shift = {-0.5, -0.5}
            }
